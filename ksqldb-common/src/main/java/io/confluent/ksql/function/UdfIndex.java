...
/**
 * An index of all method signatures associated with a UDF. This index supports lookups based on
 * method signatures, defined by a list of nullable {@link ParamType}.
 *
...
public class UdfIndex<T extends FunctionSignature> {
  ...
  /**
   * A class that represents a parameter, with a schema and whether or not it is part of a variable
  ...
  private static final class Parameter {
     ...
     * @param reservedGenerics a mapping of generics to already reserved types - this map will be
     *                         updated if the parameter is generic to point to the current argument
     *                         for future checks to accept
     * @param allowCasts       whether or not to accept an implicit cast
     * @return whether or not this argument can be used as a value for this parameter
     */
