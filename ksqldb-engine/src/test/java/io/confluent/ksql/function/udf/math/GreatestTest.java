...
public class GreatestTest {
  ...
  public void shouldWorkInNormalCase(){
    ...
    assertThat(udf.greatest(new BigDecimal("0"), new BigDecimal(".1"),
  ...
  public void shouldHandleSomeNullColumns(){
    ...
    assertThat(udf.greatest(null, null, 39D, -49.01, -11.98, 68.1, .32, null, 101D), is(101D)); //break line or go over?
    ...
    assert udf.greatest(null, new BigDecimal("27"), null, new BigDecimal("-49"),
        new BigDecimal("11"), null).equals(new BigDecimal("27"));
    assert udf.greatest(null, "apple", null, "banana", "kumquat", null).equals("kumquat");
  }
